...
from mjlab.tasks.tracking.config.z2.env_cfgs import (
...
Z2_JOINT_NAMES: Final[list[str]] = [
  ...
  "revo2_right_hand_right_thumb_metacarpal_joint",
  "revo2_right_hand_right_thumb_proximal_joint",
  "revo2_right_hand_right_thumb_distal_joint",
  "revo2_right_hand_right_index_proximal_joint",
  "revo2_right_hand_right_index_distal_joint",
  "revo2_right_hand_right_middle_proximal_joint",
  "revo2_right_hand_right_middle_distal_joint",
  "revo2_right_hand_right_ring_proximal_joint",
  "revo2_right_hand_right_ring_distal_joint",
  "revo2_right_hand_right_pinky_proximal_joint",
  "revo2_right_hand_right_pinky_distal_joint",
  ...
  "revo2_left_hand_left_thumb_metacarpal_joint",
  "revo2_left_hand_left_thumb_proximal_joint",
  "revo2_left_hand_left_thumb_distal_joint",
  "revo2_left_hand_left_index_proximal_joint",
  "revo2_left_hand_left_index_distal_joint",
  "revo2_left_hand_left_middle_proximal_joint",
  "revo2_left_hand_left_middle_distal_joint",
  "revo2_left_hand_left_ring_proximal_joint",
  "revo2_left_hand_left_ring_distal_joint",
  "revo2_left_hand_left_pinky_proximal_joint",
  "revo2_left_hand_left_pinky_distal_joint",
...
Z2_COLLISION_GEOM_PATTERN: Final[str] = r"^(.*_collision_0|(left|right)_foot_contact_\d+)$"
Z2_CSV_NUM_COLS: Final[int] = 7 + len(Z2_JOINT_NAMES)
...
class MotionLoader:
  ...
  def _load_motion(self):
    ...
    if motion.ndim != 2:
      raise ValueError(
        f"Expected a 2D motion CSV array, got shape {tuple(motion.shape)}."
      )
    if motion.shape[1] != Z2_CSV_NUM_COLS:
      raise ValueError(
        "Z2 CSV must contain 58 columns "
        f"(7 root columns + 51 joint columns). Got {motion.shape[1]} columns."
      )
    # motion[:, 2] -= 0.05
...
def get_tracking_robot(scene: Scene) -> tuple[Entity, list[int]]:
  ...
  robot_joint_indexes = robot.find_joints(
    Z2_JOINT_NAMES, preserve_order=True
  )[0]
  if len(robot_joint_indexes) != len(Z2_JOINT_NAMES):
    raise ValueError(
      "Failed to resolve all Z2 joints in the replay robot. "
      f"Expected {len(Z2_JOINT_NAMES)}, got {len(robot_joint_indexes)}."
    )
...
def analyze_foot_penetration(
  ...
  motion: MotionLoader,
  clearance: float,
  foot_geom_pattern: str = Z2_FOOT_GEOM_PATTERN,
  show_progress: bool = True,
) -> GroundingStats:
...
def main(
  ...
  whole_body_geom_pattern: str = Z2_COLLISION_GEOM_PATTERN,
  ...
  Args:
    ...
    whole_body_geom_pattern: Regex used by phased alignment to measure Z2 whole-body collisions.
